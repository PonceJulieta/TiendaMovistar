...
describe('Casos de prueba', ()=>{
    ...
    it('CP001 - Visualizar intereses  - Interés.0', ()=>{
        ...
        const interesBuilder = new movistarBuilder().interes0().build()

        datosPage.getequipo().eq(0).trigger('mouseover').click();
        ...
        datosPage.getcuotas().contains(interesBuilder.interes)
        datosPage.getcuotas().screenshot('tablaIntereses');
    })
    ...
    it('CP002 - Buscar Samsung en filtro - filtro.Samsung', () =>{
        ...
        //datosPage.getfabricante().to.have.text(marcaBuilder.samsung);
        datosPage.getmarca().eq(0);
    ...
    it('CP007  Verificar contenido en menú - Perfil.Negocios', () => {
        ...
        //pasar parametros porque si no, no lo usa.
